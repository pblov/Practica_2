<div id="modal-empresas" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="formulario-empresas" class="form-element" autocomplete="off">
                <div class="modal-body">
                    <div class="col-md-12">
                                    ...
                                    <p><div class="fileinput" >
                                        ...
                                        <div><br>
                                            <span class="btn btn-outline-secondary btn-sm btn-file" id="form-notificacion-boton-imagen-us-cargar">
                                                <span id="btn-imagen-cargar-nueva">Cargar   </span>
                                                <span id="btn-imagen-cambiar">Cambiar </span>
                                                <input type="file" name="form-empresas-foto" id="form-empresas-foto" accept="image/jpeg, image/png"> </span>
                        ...
                        <div class="row  mt-3">
                             ...
                             <div class="col-sm-4">
                                 <div class="form-group form-custom-icon-left" >
                                    <label for="form-empresas-nombre">Nombre Empresa</label>
                                    <span class="form-custom-icon"><i class="fa fa-pencil"></i></span>
                                    <input type="text" name="nombre" class="form-control" id="form-empresas-nombre"  maxlength="50" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mb-3">
                            ...
                            <div class="col-sm-6">
                                 <input type='hidden' id="form-empresas-id" />    
